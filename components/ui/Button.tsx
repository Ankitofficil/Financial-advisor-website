...
const base =
  ...
  "min-h-[44px] cursor-pointer disabled:opacity-60 disabled:pointer-events-none";

const variants: Record<Variant, string> = {
  primary:
    "btn-sheen bg-ink text-white hover:bg-slate shadow-[0_10px_30px_-12px_rgba(11,31,58,0.55)] hover:shadow-[0_16px_36px_-12px_rgba(11,31,58,0.6)]",
  secondary:
  ...
  // is unreliable.
  gold: "btn-sheen bg-gold text-ink hover:bg-[color-mix(in_srgb,var(--color-gold)_85%,white)] shadow-[0_10px_30px_-12px_rgba(11,31,58,0.45)] hover:shadow-[0_16px_36px_-12px_rgba(11,31,58,0.5)]",
};
