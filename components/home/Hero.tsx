  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="anim-float absolute -right-40 -top-40 h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle,rgba(79,174,135,0.06),transparent_70%)]" />
        <div
          className="anim-float absolute -left-32 bottom-[-160px] h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle,rgba(217,185,92,0.05),transparent_70%)]"
...
function PlanSnapshot() {
  return (
    <div className="card-tilt relative rounded-[var(--radius-lg)] border hairline bg-card p-6 shadow-[0_30px_60px_-30px_rgba(0,10,6,0.35)] hover:shadow-[0_40px_72px_-32px_rgba(0,10,6,0.45)] sm:p-8">
