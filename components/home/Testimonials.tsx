        ...
        <RevealGroup className="mt-12 grid gap-6 lg:grid-cols-3">
          {testimonials.map((t) => (
            <RevealItem key={t.name} className="h-full">
              <figure className="flex h-full flex-col rounded-[var(--radius-lg)] border hairline bg-card p-7 transition-all duration-300 hover:-translate-y-1 hover:border-[color-mix(in_srgb,var(--color-gold)_45%,transparent)] hover:shadow-[0_24px_48px_-28px_rgba(0,10,6,0.35)]">
