    ...
    <section className="section section-alt">
      <Container>
        ...
        <RevealGroup className="mt-12 grid gap-6 md:grid-cols-3">
          {steps.map((s) => (
            <RevealItem key={s.n}>
              <div className="group h-full rounded-[var(--radius-lg)] border hairline bg-card p-7 transition-all duration-300 hover:-translate-y-1 hover:border-[color-mix(in_srgb,var(--color-gold)_50%,transparent)] hover:shadow-[0_24px_48px_-28px_rgba(0,10,6,0.4)]">
